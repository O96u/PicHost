...
| 分支 | 说明 |
| ---- | ---- |
| [**main**](https://github.com/O96u/PicHost/tree/main)（默认） | **v1.1.4** 主线：本地磁盘 + 多对象存储、双域名双向隔离、[`/storage`](docs/README.md) 存储管理、混合直链 |
...
| 版本       | 说明                                              |
| ---------- | ------------------------------------------------- |
| **v1.1.4** | 存储路径扁平/分组、basename 外链、双域名双向隔离（当前 main） |
